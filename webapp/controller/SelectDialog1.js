sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.prototipoDeAltaFidelidad.controller.SelectDialog1", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.prototipoDeAltaFidelidad.view.SelectDialog1", this);
			this._bInit = false;
		},
